...
def build_enriched(df):
    try:
        ...
        # On affiche l'erreur pour les logs Airflow
        print(f"ERREUR FATALE LORS DE LA TRANSFORMATION : {e}")
        # On relance l'erreur pour forcer le crash du script et faire rougir Airflow !
        raise